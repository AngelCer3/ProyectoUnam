...
@Entity(tableName = "acreditados")
data class AcreditadoEntity(
    @PrimaryKey (autoGenerate = true) val id_acreditado: Int = 0,
...
data class VisitasEntity(
    @PrimaryKey(autoGenerate = true) val id_visita: Int = 0,
...
@Entity(tableName = "datos_vivienda")
data class DatosViviendaEntity(
    @PrimaryKey(autoGenerate = true) val id_vivienda: Int = 0,
...
@Entity(tableName = "datos_credito")
data class DatosCreditoEntity(
    @PrimaryKey(autoGenerate = true) val id_credito: Int = 0,
...
@Entity(tableName = "datos_reestructura")
data class DatosReestructuraEntity(
    @PrimaryKey(autoGenerate = true) val id_reestructura: Int = 0,
...
@Entity(tableName = "datos_conyuge")
data class DatosConyugeEntity(
    @PrimaryKey(autoGenerate = true) val id_conyuge: Int = 0,
...
@Entity(tableName = "datos_solicitante")
data class DatosSolicitanteEntity(
    @PrimaryKey(autoGenerate = true) val id_solicitante: Int = 0,
...
@Entity(tableName = "datos_gastos")
data class DatosGastosEntity(
    @PrimaryKey(autoGenerate = true) val id_gastos: Int = 0,
...
@Entity(tableName = "datos_telefonos")
data class DatosTelefonosEntity(
    @PrimaryKey(autoGenerate = true) val id_telefonos: Int = 0,
...
@Entity(tableName = "datos_cobranza")
data class DatosCobranzaEntity(
    @PrimaryKey(autoGenerate = true) val id_cobranza: Int = 0,
...
@Entity(tableName = "datos_documentos")
data class DatosDocumentosEntity(
    @PrimaryKey(autoGenerate = true) val id_documentos: Int = 0,
...
@Entity(tableName = "datos_observaciones")
